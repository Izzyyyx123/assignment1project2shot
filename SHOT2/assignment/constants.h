...
static const unsigned SCREEN_WIDTH = 1720u;
static const unsigned SCREEN_HEIGHT = 880u;
...
// PARTICLE_SPAWN_RATE sets how many particles can be spawned in a SINGLE FRAME.
